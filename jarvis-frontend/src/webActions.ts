...
const knownWebsitesPattern = /\b(youtube|spotify|google|reddit|twitter|x\.com|github|wikipedia|netflix|amazon|twitch|instagram|facebook|linkedin|discord|gmail|solarmoviez|newgrounds|rule34)\b/i;
const domainPattern = /(?:https?:\/\/|www\.)?[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?\.(?:com|org|net|io|edu|gov|dev|app|co|ai|in|tv|xxx|to|is|cc|me|info|biz|uk|us|ca|de|jp|fr|au|ru|ch|it|nl|se|no|es|[a-z]{2,})(?:\/[^\s]*)?/i;
